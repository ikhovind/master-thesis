...
With their early appearance for inter-process communication in
the Berkeley Software Distribution version 4.2 in 1983, sockets
have grown to become the dominant way low-level network
programming is done today. [citation] As mentioned previously,
the original Berkeley sockets were designed for inter-process
communication. As a continuation of this, the implementation of
...
properties, connection properties and message properties. Selection
...
TODO - when can these be set? Talk about preestablishment phase.
