...
\node[field] (t1) at (1.3,-1.05) {src IP:\;10.0.0.1};
\node[field] (t2) at (1.3,-1.75) {src port:\;54321};
\node[field] (t3) at (1.3,-2.45) {dst IP:\;93.184.216.34};
...
\node[field]     at (7.3,-1.75) {src IP:\;10.0.0.1};
\node[field]     at (7.3,-2.45) {src port:\;54321};
\node[field]     at (7.3,-3.15) {dst IP:\;93.184.216.34};
 
% Arrow
\node at (7.3,-3.7) {$\downarrow$ IP change};
 
% After
\node[lbl] at (7.3,-4.15) {after migration};
\node[highlight] at (7.3,-4.7)  {CID:\;0xABCD1234\;{\normalfont\bfseries\textcolor{green!50!black}{unchanged}}};
\node[dead]      at (7.3,-5.4)  {src IP:\;10.0.1.1\;{\normalfont\bfseries\textcolor{red!70}{changed}}};
\node[field]     at (7.3,-6.1)  {src port:\;54321};
\node[field]     at (7.3,-6.8)  {dst IP:\;93.184.216.34};
 
\node[draw=green!60!black, fill=green!15, rounded corners, font=\small,
      text=green!50!black] at (7.3,-7.6) {Connection survives \checkmark};
 
\end{tikzpicture}
\caption{TCP 4-tuple vs QUIC connection after path event.}
\label{fig:connectionBeforeAfterMigration}
\end{figure} \todo{Add QUIC port, change to benchmark IPs}
