...
For a QUIC connection if a local interface goes down then it is able to attempt
sending on another interface. If the peer is reachable over the path, then
the transfer can continue with minor interruption.
