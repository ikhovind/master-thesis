...
configure_file(resources/key.pem resources/key.pem COPYONLY)
    \end{minted}
    \caption[CTaps application example CMakeLists.txt]
    {
        Example CMakeLists.txt for an application
        fetching CTaps as a dependency through FetchContent.
        This file is used in the CTaps example project~\cite{ctaps-example-project}.
    }
...
\end{minted}
\captionof{listing}[CTaps exapmle client]
{
