...
static int ct_quic_send_packet_with_pktinfo(ct_udp_poll_handle_t* poll_handle,
    ...
    {
Function used to send QUIC packets over UDP for Picoquic, controlling
the from address to match what is specified by Picoquic by using cmesg.
    }
    \label{lst:pktinfo-send-packet}
\end{listing}


\chapter{Doxygen Documentation} \label{chap}
