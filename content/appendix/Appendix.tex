...
an application can benefit from multistreaming through Connection cloning,
...
{
A CTaps client utilizing connection cloning.
...
then the Connection cloning will utilize multistreaming. If TCP
