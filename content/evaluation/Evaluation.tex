...
\subsection{Summary}
To summarize, the experiments collectively show that CTaps achieves performance
parity with native implementations in I/O-bound scenarios, but more testing
is required to establish CTaps' behavior under load.
CTaps successfully exposes QUIC-specific features such as connection migration and multistreaming,
