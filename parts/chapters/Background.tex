...
\section{Existing TAPS implementations}
% There are already several working TAPS implementations, but they
% are lacking in different ways. Two prominent implementations are
% \texttt{dynamic-taps} implemented in C and
% \texttt{python-asyncio-taps} implemented in Python
% \cite{dukeDynamictaps2025}\todo{Is this actually the one Michael
% 	was talking about, what is NEAT?}
% \cite{frankePythonasynciotaps2025}. This thesis aims to be an
% improvement over these implementations. By being a C
% implementation it will be suitable for lower level applications.
% It aims to improve on the existing C implementation by being
% more modular and easier to use. Currently, \texttt{dynamic-taps}
% is a monolitic implementation \todo{is this actually true} and
% has not been updated since 2021. This thesis will provide an
% alternative written after the final TAPS RFC has been published.
% It will also be more modular and well tested, making it easier
% to use an to integrate into an existing library or application.
