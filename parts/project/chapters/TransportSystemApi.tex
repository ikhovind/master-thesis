...
\section{Callbacks} \todo{Can I write some numbers here, how much is I/O bound as a percentage?}
...
\section{Callbacks}
List of callbacks, how there are passed and where they are invoked,
table of callbacks and associated objects.
